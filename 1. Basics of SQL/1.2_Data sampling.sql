...
-- Задание
-- В конце года цену каждой книги на складе пересчитывают – снижают ее на 30%. Написать SQL запрос, который из таблицы book выбирает названия, авторов, 
...
-- Задание
-- Вывести исключительно произведение Достоевского - Идиот используя LIKE.

SELECT title AS Название, author AS Автор, price AS Цена, amount AS Количество
FROM book
WHERE title LIKE "И%" AND title LIKE "%Т";
